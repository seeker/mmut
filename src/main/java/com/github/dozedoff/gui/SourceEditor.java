...
public class SourceEditor extends JFrame {
	...
	private void createSourceDialog(Webpage page) {
		...
		Object[] message = { "Source name: ", sourceName, "Source URL: ", sourceUrl, "CSS selector: ", cssSelector, "Page pattern: ",
				pagePattern, "Page start index: ", pageStart, "Page end index", pageEnd };
